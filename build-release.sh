...
INC_MINOR="false"
INC_MAJOR="false"
WORKSPACE=$JENKINS_HOME/jobs/psistatsrd/workspace
...
svn copy https://dev.psikon.org/svn/psistatsrd/trunk https://dev.psikon.org/svn/psistatsrd/branches/$VERSION -m "Creating branch for version $VERSION"
...
GIT_REPO=psistatsrd
SVN_URL=https://dev.psikon.org/svn/psistatsrd
